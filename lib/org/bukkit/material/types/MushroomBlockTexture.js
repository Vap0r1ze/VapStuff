...
class MushroomBlockTexture {
    ...
    static get STEM_SIDES() {
        return this.$javaClass.STEM_SIDES;
    }
}
exports.default = MushroomBlockTexture;
