export default class LootTables {
    ...
    static get UNDERWATER_RUIN_BIG() {
        return this.$javaClass.UNDERWATER_RUIN_BIG;
    }
    static get UNDERWATER_RUIN_SMALL() {
